...
// ]]>
	...
	<table class='overtable' cellpadding='0' cellspacing='0'>
		...
		<tr class='regular_nowrap' style='background-color:#EDF6FF; '>
			...
			<td><a href='http://www.bellezajuiceplus.com' target='_blank'>" . $row["nm_dom"]. "</a></td>";
				...
				echo "	<td class='centered_cell'>" . $row["jdl_dom"]. "</td>
						<td class='centered_cell'>0&nbsp;</td>
						<td class='centered_cell'><span style='color:#008000;'>Approved</span></td>
