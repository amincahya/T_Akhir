						...
						<div id='wrapper'>
							<div id='accountSwitch' class='clearfix'>  
								<div style='width:100%; display:inline; margin:0 5px 0 0;'>
									<div style='float:left; margin:4px 0 0 0;'><span class='smallWhite'>List </span><span class='smallYellow'></span>
								  <span class='smallWhite'>account id:</span><span class='smallYellow'></span>
									&nbsp;
									</div>
									<ul style='margin:4px 0 0 5px;'><li class='partner'><a href='#' class='partner'>Login</a></li></ul>
								</div>
							</div>
