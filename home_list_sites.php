...
// ]]>-->
					...
					<tbody><tr>
						...
						<td>
							<select name='sort_by' class='longer'>
									<option value='0' selected='selected'>Site: A-Z</option>
									<option value='1'>Site: Z-A</option>
									<option value='2'>Niche: A-Z</option>
									<option value='3'>Niche: Z-A</option>
	...
	<table class='overtable' cellpadding='0' cellspacing='0'>
		<tbody><tr class='tabletop header_nowrap'>
			...
			<td class='centered_cell'>Create Data</td>
			<td>Website</td>
		...
		<tr class='regular_nowrap' style='background-color:#EDF6FF; '>
			<td class='centered_cell' style='background-color:#E4F1FF; '>" . $row["kd_dom"]. "</td>
			...
			<td style='background-color:#E4F1FF; '>
				...
				echo "	<td class='centered_cell' style='background-color:#E4F1FF; '>" . $row["DA"]. "</td>
						<td class='centered_cell'>" . $row["PR"]. "</td>
						<td class='centered_cell' style='background-color:#E4F1FF; '>" . $row["AR"]. "</td>
						<td class='centered_cell'>" . $row["IPS"]. "</td>
						<td class='centered_cell' style='background-color:#E4F1FF; '><span style='color:#008000;'>" . $row["st_dom"]. "</span></td>
